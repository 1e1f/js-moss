...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "start", "symbols": ["start$ebnf$1", "_", "locators"], "postprocess": 
        ([strip, ws, code]) => code
        },
    {"name": "start$ebnf$2", "symbols": []},
    {"name": "start$ebnf$2", "symbols": ["start$ebnf$2", "strip"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "start", "symbols": ["start$ebnf$2", "_", {"literal":"?"}, "queries"], "postprocess": 
        ([strip, ws, q, code]) => code
        },
    {"name": "locators", "symbols": ["locators", {"literal":","}, "locator"], "postprocess": 
        ([bls, comma, bl]) => {
        	const iter = Array.isArray(bls) ? bls : [bls];
        	return [
        		...iter,
    ...
    {"name": "locators", "symbols": ["locator"], "postprocess": id},
    {"name": "locator$ebnf$1", "symbols": ["locatorHead"], "postprocess": id},
    {"name": "locator$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "locator$ebnf$2", "symbols": ["locatorTail"], "postprocess": id},
    {"name": "locator$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "locator", "symbols": ["locator$ebnf$1", "locator$ebnf$2"], "postprocess": 
        ([head, tail]) => {
        	if (!head && !tail) return null;
          return {
        	...head,
    ...
    {"name": "locatorHead$ebnf$1", "symbols": ["disambiguatedChunk"], "postprocess": id},
    {"name": "locatorHead$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "locatorHead$string$1", "symbols": [{"literal":":"}, {"literal":":"}], "postprocess": (d) => d.join('')},
    {"name": "locatorHead$ebnf$2", "symbols": ["locatorHead"], "postprocess": id},
    {"name": "locatorHead$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "locatorHead", "symbols": ["_", "locatorHead$ebnf$1", "_", "locatorHead$string$1", "locatorHead$ebnf$2"], "postprocess": 
        ([ws, contextSegment, ws2, mark, nameSegmentPart]) => {
        	if (!contextSegment && !nameSegmentPart){
        		return {};
        	}
    ...
    {"name": "locatorHead", "symbols": ["_", "caseInsensitiveChunk", "_"], "postprocess": ([ ws, nameSegment ]) => ({nameSegment})},
    {"name": "locatorTail$ebnf$1", "symbols": ["tailSegment"]},
    {"name": "locatorTail$ebnf$1", "symbols": ["locatorTail$ebnf$1", "tailSegment"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "locatorTail", "symbols": ["locatorTail$ebnf$1"], "postprocess": 
        ([segments]) => {
          const locator = {};
    ...
    {"name": "tailSegment", "symbols": ["versionSegment"], "postprocess": id},
    {"name": "tailSegment", "symbols": ["caseInsensitiveSegment"], "postprocess": id},
    {"name": "tailSegment", "symbols": ["disambiguatedSegment"], "postprocess": id},
    {"name": "versionSegment", "symbols": [/[:]/, "_", "versionChunk", "_"], "postprocess":  ([ mark, ws, group]) => {
        return [symbolToSegmentKey(mark), group];
        } },
    {"name": "caseInsensitiveSegment", "symbols": [/[~]/, "_", "caseInsensitiveChunk", "_"], "postprocess":  ([ mark, ws, group]) => {
        return [symbolToSegmentKey(mark), group];
        } },
    {"name": "disambiguatedSegment", "symbols": [/[@]/, "_", "disambiguatedChunk", "_"], "postprocess":  ([ mark, ws, group]) => {
        return [symbolToSegmentKey(mark), group];
        } }
  ],
  ParserStart: "start",
