...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "caseInsensitiveChunk", "symbols": ["caseInsensitiveChunk", "_", "semanticDivider"], "postprocess": ([lhs, ws, exp]) => lhs + exp},
    ...
    {"name": "disambiguatedChunk", "symbols": ["disambiguatedChunk", "_", "disambiguatedDivider", "_", "disambiguatedString"], "postprocess": ([lhs, ws, exp, ws2, rhs]) => lhs + rhs},
    ...
    {"name": "disambiguatedDivider", "symbols": ["nonSemanticDivider"]},
    {"name": "disambiguatedDivider", "symbols": ["semanticDivider"]},
    ...
    {"name": "start", "symbols": ["start$ebnf$1", "_", "caseInsensitiveChunk", "_"], "postprocess": 
        ([strip, ws, code]) => code
        }
  ],
  ParserStart: "start",
