...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "caseInsensitiveChunk", "symbols": ["caseInsensitiveChunk", "gap", "caseInsensitiveChunk"], "postprocess": ([lhs, gap, rhs]) => lhs + rhs},
    ...
    {"name": "disambiguatedChunk", "symbols": ["disambiguatedChunk", "gap", "disambiguatedChunk"], "postprocess": ([lhs, gap, rhs]) => lhs + rhs},
