...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "caseInsensitiveChunk", "symbols": ["caseInsensitiveChunk", "gap", "caseInsensitiveChunk"], "postprocess": join},
    ...
    {"name": "caseInsensitiveChunk", "symbols": ["caseInsensitiveChunk", "_", "nonSemanticDivider"], "postprocess": join},
    {"name": "caseInsensitiveChunk", "symbols": ["caseInsensitiveString"], "postprocess": id},
    {"name": "disambiguatedChunk", "symbols": ["disambiguatedChunk", "gap", "disambiguatedChunk"], "postprocess": join},
